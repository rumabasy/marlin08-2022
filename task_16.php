                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    ...
                                    <form action="task_16_handler.php" method="post">
                                        ...
                                        <button class="btn btn-success mt-3" type="submit">Вход</button>
                                    </form>
                                    <?php endif ?>
                                    <?php if(isset($_SESSION['success'])): ?>
                                        <form action="task_16_handler2.php" method="post">
                                            <button class="btn btn-danger mt-3" type="submit">Выйти</button>
                                        </form>
                                    <?php endif ?>
                                </div>
                            </div>
