                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div id="js-lightgallery">
                                ...
                                <a class="" href="img/demo/gallery/<?php echo $picture['href'] ?>.jpg">
                                    <img class="img-responsive" src="img/demo/gallery/thumb/<?php echo $picture['href'] ?>.jpg" alt="image">
                                </a>                                
                                <?php endforeach ?> -->
                                <?php $pictures=[
                                [
                            ...
                            <div id="js-lightgallery">
                                <?php foreach($pictures as $picture): ?>
                                <a class="" href="<?php echo $picture['href'] ?>">
                                    <img class="img-responsive" src="<?php echo $picture['href'] ?>" alt="image">
                                </a>                                
                                <?php endforeach ?>
                            </div>
                        </div>
